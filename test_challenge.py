...
def test_image(file):
	# reading in an image and find the ROI
	img = mpimg.imread(file)
	# cv2.line(img, (100, 650),(600,430), (255,0,0),2)
	# cv2.line(img, (600,430),(750,430), (255,0,0),2)
	# cv2.line(img, (750,430),(1170, 650), (255,0,0),2)
	# cv2.line(img, (160, 650),(630,430), (255,0,0),2)
	# cv2.line(img, (630,430),(700,430), (255,0,0),2)
	...
	plt.title('masked_edges_ROI')

	# white_mask = HSV_mask(img, white_threshold) # use blured image as base
...
def test_images(folder_src,folder_dst="test_images_output/challenge"):
